...
:uri-plugin: https://github.com/danyill/oscd-remove-ieds
:uri-ci-bundle: https://danyill.github.io/oscd-remove-ieds/oscd-remove-ieds.js
:uri-material-icons: https://fonts.google.com/icons
:uri-openscd-core-plugin-demo: https://danyill.github.io/oscd-remove-ieds/index.deploy.html
...
// badges
image:https://github.com/danyill/oscd-remove-ieds/actions/workflows/test.yml/badge.svg[title='Build Status']
...
This plugin is intended to allow a user to remove multiple IEDs from an SCL file.
...
For a local resource, begins without a forward slash, e.g. `plugins/oscd-remove-ieds/dist/oscd-remove-ieds.js`. 
...
<open-scd
  ...
  "editor": 
  [
    {"name": "Subscriber Later Binding", "translations": {"de": "Späte Bindung des Abonnenten", "pt": "Associação Tardia de Assinante"}, "icon": "link", "active": true, "requireDoc": true, "src": "/plugins/oscd-remove-ieds/dist/oscd-remove-ieds.js"}
  ]
}'
></open-scd>
----
